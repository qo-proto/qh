...
The current dataset was collected from typical web browsing including: Video streaming (YouTube), search engines, blogs, etc.
...
```bash
go run benchmark/cmd/generate-testcases/main.go traffic.har
```
